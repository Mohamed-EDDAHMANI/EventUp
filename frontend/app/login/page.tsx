        ...
        <div className="rounded-2xl border border-brand-deep/50 bg-brand-deep/20 p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 w-full rounded-xl bg-brand-accent py-3 font-semibold text-white transition hover:bg-brand-mid disabled:opacity-50 disabled:cursor-not-allowed"
            >
